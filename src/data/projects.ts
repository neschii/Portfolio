...
export const projects: Project[] = [
  ...
  {
    title: 'Weather App',
    description: 'A simple app that displays current weather conditions.',
  ...
  {
    title: 'Task Manager',
    description: 'A productivity app to organize daily tasks.',
  ...
  {
    title: 'E-commerce UI',
    description: 'A modern shopping experience layout with responsive design.',
    tech: ['React', 'CSS'],
